...
import fr.javatic.mongo.jacksonCodec.javaTime.deserializers.NotLongDateDeserializer;
...
import fr.javatic.mongo.jacksonCodec.javaTime.serializers.NotLongDateSerializer;
...
public class JavaTimeBsonModule extends Module {
    ...
    public static class Java8TimeBsonSerializers extends SimpleSerializers {
        public Java8TimeBsonSerializers() {
            ...
            addSerializer(Date.class, new NotLongDateSerializer());
        }
    }
    ...
    public static class Java8TimeBsonDeserializers extends SimpleDeserializers {
        public Java8TimeBsonDeserializers() {
            ...
            addDeserializer(Date.class, new NotLongDateDeserializer());
        }
    }
}
